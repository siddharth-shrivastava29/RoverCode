...
%GAIT ARRAYS
FLE = [ FLExtendUp FLExtendUp FLExtendUp FLExtendUp FLExtendUp FLExtendDown FLExtendDown FLExtendDown FLExtendDown FLExtendDown]
FRE = [ FRExtendDown FRExtendDown FRExtendDown FRExtendDown FRExtendDown FRExtendUp FRExtendUp FRExtendUp FRExtendUp FRExtendUp]
BLE = [ BLExtendDown BLExtendDown BLExtendDown BLExtendDown BLExtendDown BLExtendUp BLExtendUp BLExtendUp BLExtendUp BLExtendUp]
BRE = [ BRExtendUp BRExtendUp BRExtendUp BRExtendUp BRExtendUp BRExtendDown BRExtendDown BRExtendDown BRExtendDown BRExtendDown]
FLR = [ FLPropel FLReset FLReset FLReset FLReset FLReset FLPropel FLPropel FLPropel FLPropel]
FRR = [ FRReset FRPropel FRPropel FRPropel FRPropel FRPropel FRReset FRReset FRReset FRReset]
BLR = [ BLReset BLPropel BLPropel BLPropel BLPropel BLPropel BLReset BLReset BLReset BLReset]
BRR = [ BRPropel BRReset BRReset BRReset BRReset BRReset BRPropel BRPropel BRPropel BRPropel]

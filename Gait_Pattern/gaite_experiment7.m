...
%GAIT ARRAYS
FLE = [ FLExtendDown FLExtendDown FLExtendUp FLExtendUp FLExtendDown FLExtendDown FLExtendDown]
FRE = [ FRExtendDown FRExtendDown FRExtendDown FRExtendDown FRExtendDown FRExtendUp FRExtendUp]
BLE = [ BLExtendDown BLExtendDown BLExtendDown BLExtendDown BLExtendDown BLExtendUp BLExtendUp]
BRE = [ BRExtendDown BRExtendDown BRExtendUp BRExtendUp BRExtendDown BRExtendDown BRExtendDown]
FLR = [ FLReset FLPropel FLPropel FLReset FLReset FLReset FLReset]
FRR = [ FRReset FRPropel FRPropel FRPropel FRPropel FRPropel FRReset]
BLR = [ BLReset BLPropel BLPropel BLPropel BLPropel BLPropel BLReset]
BRR = [ BRReset BRPropel BRPropel BRReset BRReset BRReset BRReset]
